    ...
    public function show(AuthorizationCheckerInterface $auth)
    {
        if ($auth->isGranted("ROLE_ADMIN"))
        {
            $liens = [
                ...
                // ['href' => 'paniers',    'lib' => 'Paniers',      'icon' => 'fas fa-shopping-basket'],
                // ['href' => 'produits', 'lib' => 'Produits',   'icon' => 'fas fa-plus-circle'],
                // ['href' => 'tags',          'lib' => 'Etiquettes',   'icon' => 'fas fa-plus-circle'],
                // ['href' => 'categories',    'lib' => 'Categorie',   'icon' => 'fas fa-plus-circle'],
